...
export default function Aboutpage(){
    ...
    return(
      <>
      <div class="mx-auto px-4 mt-10 w-full md:px-8">
    <h1 class="text-7xl md:text-7xl text-center mt-32 mb-10 md:mb-0 animate__zoomIn animate__animated text-black font-bold">Our Mission & Vision</h1>
    <div class="flex flex-col md:flex-row px-4 w-full">
        <div class="w-full md:w-1/2 animate__zoomIn animate__animated px-4 mr-5">
            <p class="text-lg md:text-2xl font-bold text-black ml-5 mt-5">Mission</p>
            <p class="text-lg md:text-xl text-black ml-5">Help our stakeholders achieve their strategic goals by providing smart solutions.</p>
            <p class="text-lg md:text-2xl font-bold text-black ml-5 mt-5">Vision</p>
            <p class="text-lg md:text-xl text-black ml-5">To become the best business and IT consulting organization for our stakeholders.</p>
            <p class="text-lg md:text-2xl font-bold text-black ml-5 mt-5">Making IT Better</p>
            <p class="text-lg md:text-xl text-black ml-5">RBK has come far from being a small corner-of-a-room start-up software development company to a global IT and business consulting organization with a decent services and solutions portfolio for diverse sets of industries.</p>
        </div>
        <div class="md:w-1/2">
            <img src="o.jpg" alt="Image Description" class="w-full mb-10 mt-5 animate__zoomIn animate__animated rounded-lg mr-40 md:mr-0 h-auto md:h-96"/>
        </div>
    </div>
...
<div class="mx-auto px-4 mt-10 md:px-8">
    <div class="flex flex-col md:flex-row px-4 w-full">
        <div class="md:w-1/2">
            <img src="crs.jpg" alt="Image Description" class="w-full mb-5 mt-10 md:mt-0 animate__zoomIn animate__animated rounded-lg h-auto md:h-64"/>
        </div>
        <div class="w-full md:w-1/2 mr-10 animate__zoomIn ml-10 animate__animated px-4">
            <p class="text-4xl md:text-4xl text-black font-bold mt-5 md:mt-0">Corporate Social Responsibility</p>
            <p class="text-lg md:text-xl text-black mt-5 mb-2">We at RBK aim to achieve clear and definite standards of good corporate social citizenship in all areas of our business.</p>
            <p class="text-lg text-black md:text-lg mb-2">We have therefore determined to bring together existing operating principles and policies under the umbrella of Corporate Social Responsibility.</p> 
        </div>
    </div>
</div>
...
<div class="flex flex-col md:flex-row px-4 w-full">
    <div class="w-full md:w-1/2 animate__zoomIn animate__animated px-4">

        <p class="text-4xl md:text-4xl text-black font-bold ml-5 mt-5">Track Record</p>

        <p class="text-lg md:text-xl font-bold text-black ml-5 mt-5">Making IT better</p>
        <p class="text-lg md:text-xl text-black ml-5">RBK has come far from being a small corner-of-a-room start-up software development company to a global IT and business consulting organization with a decent services and solutions portfolio for diverse sets of industries.</p>

    </div>
    <div class="md:w-1/2 flex justify-center items-center">
        <img src="track.jpg" alt="Image Description" class="w-3/4 md:w-full mb-5 mt-5 animate__zoomIn animate__animated rounded h-auto md:h-64"/>
    </div>
</div>


<div class="flex flex-col bg-white w-full">
    <h1 class="text-5xl md:text-5xl text-center font-bold mt-10 px-4">Momentum: How to Become a Successful Consultant.</h1>
    <div class="flex flex-col md:flex-row px-4 mt-5">
        <div class="md:w-1/2 md:mr-4">
            <img src="client.jpg" alt="Image Description" class="w-full md:w-3/4 h-auto rounded-lg mb-5 mx-auto md:ml-0"/>
        </div>
        <div class="md:w-1/2 mt-5">
            <p class="text-lg md:text-xl text-black mb-2">Momentum is our newest implementation program for early-stage consultants. If you'd like a proven plan and system that you can follow step-by-step to land your first few clients and reach six-figures as a consultant this program is for you.</p>
            <p class="text-lg md:text-xl text-black mb-2">We have therefore determined to bring together existing operating principles and policies under the umbrella of corporate Social Responsibility.</p>
        </div>
    </div>
</div>
